...
cmd({
    ...
    try {
        ...
        if (movie.Response === 'False') return reply('❌ Movie not found.');

        let msg = `🎥 *MOVIE INFO*\n\n`;
        msg += `*Title:* ${movie.Title}\n`;
        msg += `*Year:* ${movie.Year}\n`;
        msg += `*Rated:* ${movie.Rated}\n`;
        msg += `*Released:* ${movie.Released}\n`;
        msg += `*Runtime:* ${movie.Runtime}\n`;
        msg += `*Genre:* ${movie.Genre}\n`;
        msg += `*Director:* ${movie.Director}\n`;
        msg += `*Actors:* ${movie.Actors}\n`;
        msg += `*IMDB:* ${movie.imdbRating}/10\n`;
        msg += `*Plot:* ${movie.Plot}\n\n`;
        msg += `> ® Powered by Tyrex Tech`;
